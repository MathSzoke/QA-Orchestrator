...
public static class CommandRegistration
{
    ...
    private static Command CreateInitCommand(CliServices services)
    {
        var command = new Command("init", "Create qa-orchestrator.json and working folders.");
        command.SetAction(_ => WriteExecutionResult(services.InitializeConfiguration.Execute(Environment.CurrentDirectory)));
        return command;
    }

    private static Command CreateAnalyzeCommand(CliServices services)
    {
    ...
    private static Command CreateCleanCommand(CliServices services)
    {
    ...
    private static Command CreateBoostCommand(CliServices services)
    {
        var solutionOption = new Option<string?>("--solution", "-s")
        {
        ...
        var safeOption = new Option<bool>("--safe")
        {
    ...
    private static Command CreateMutationCommand()
    {
    ...
    private static Command CreateReportCommand(CliServices services)
    {
    ...
    private static Command CreateDoctorCommand()
    {
        ...
        command.SetAction(_ =>
        {
            var assembly = typeof(CommandRegistration).Assembly;
    ...
    private static void AddCommonSolutionOption(Command command)
    {
    ...
    private static IReadOnlyList<BoostTarget> ParseBoostTargets(string? value)
    {
    ...
    private static int WriteExecutionResult(ExecutionResult result)
    {
    ...
    private static void WriteCleanPlan(CleanPlan plan, bool dryRun)
    {
    ...
    private sealed class CliServices
    {
